  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.bulkDelete("courses", {
      name: [
        ...
        "Dominando a Linguagem Ruby",
        "Micro-serviços com Node.js",
        "Criando APIs Profissionais com Ruby on Rails",
        "TDD na Prática: Testando APIs Node.js",
        "TDD na Prática: Testando Aplicações React",
        "Especialista Front-end: Vue.js",
        "Criando Sites e Apps 3D com Three.js",
        "Dominando o Bootstrap 5",
        "Visual Studio Code para Programadores Javascript",
        "Comandos do Terminal Linux: Um Guia Completo",
        "Comunicação e Trabalho em Equipe",
        "Programador Nômade",
        "O Guia do Programador Freelancer",
      ],
    });
  },
};
